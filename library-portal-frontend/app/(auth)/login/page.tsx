...
const page = () => {
  ...
  return (
    <div
      className={`login-screen w-screen min-h-screen flex justify-center items-center`}
    >
      ...
      <div className='login rounded-2xl flex-col flex items-center p-4 gap-16 border-solid border-black border max-w-xl max-h-screen text-black'>
        ...
        <div className='login_inputs flex-col flex items-center '>
          ...
          <input
            ...
            className='w-full h-14 text-l text-black mb-7'
          />
          <div className='flex w-full p-1'>
            <h1 className='text-xl font-semibold w-full'>Password</h1>
            <Link
              href='/login/forgot'
              className='w-3/4 text-right text-sm font-semibold'
            >
              Forgot Password?
            </Link>
          </div>
          <div className='password-box login_inputs flex items-center relative p0'>
            <input
              ...
              id='password'
              onChange={handleChange}
              className=' w-full h-14 text-l p-0 m-0 text-black mb-6'
            />
            <i
          ...
          <div className='flex justify-between w-full p-2'>
            ...
            <button
              className='login-btn w-28 h-11 rounded-sm font-semibold text-white'
              onClick={handleClick}
            >
              LOGIN
            </button>
